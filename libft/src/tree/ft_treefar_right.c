...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/14 18:50:50 by hmacedo-          #+#    #+#             */
/*   Updated: 2025/09/14 20:01:12 by hmacedo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_tree	*ft_treefar_right(t_tree *tree)
{
	...
	if (!tree->right)
		return (tree);
	return (ft_treefar_right(tree->right));
}
/*
#include <stdio.h>
...
int	main(void)
{
	...
	show_t_tree(ft_treefar_right(cabeça));
	cabeça->left = left;
	cabeça->right = right;
	left->prev = cabeça;
	right->prev = cabeça;
	...
	show_tree(cabeça);
	printf("ultimo print, trazer o nó right\n");
	show_t_tree(ft_treefar_right(cabeça));
	return (0);
}*/
